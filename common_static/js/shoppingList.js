$(document).ready(function () {
    function addShoppingListEntry(good_id, good_name, good_price) {
        ...
        $.getJSON('/getShoppingList', {}, function(data, status) {
            if (status === 'success') {
                ...
                $.each(data, function(idx, info) {
                    addShoppingListEntry(info['good_id'], info['name'], info['price']);
                    total += info['price'];
                });
